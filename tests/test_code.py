...
@pytest.fixture
def txt_list ():
    t = "..\\ejemplos\\texto_1.txt ..\\ejemplos\\texto_2.txt"
    return t
...
def test_read_file_list_frec ():
    assert cd.read_file_list_frec(txt_list) == {'bien': 3, 'hola': 2, 'mundo': 2, 'como': 2, 'estan': 2, 'muy': 2, 'hoy': 2, 'todo': 2, 'por': 2, 'todos': 1, 'me': 1, 'siento': 1, 'deberiamos': 1, 'celebrarlo': 1, 'hasta': 1, 'pronto': 1, 'aqui': 1, 'gracias': 1, 'preguntar': 1}
